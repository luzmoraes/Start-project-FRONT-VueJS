...
export default {
    ...
    salesAndVisitStats: 'Estatísticas de vendas e visitas',
    ...
    blank: 'Em branco',
    session: 'Sessão',
    signUp1: 'Cadastre-se 1',
    signUp2: 'Cadastre-se 2',
    login1: 'Login 1',
    login2: 'Login 2',
    ...
    bySigningUpYouAgreeTo: 'Ao se cadastrar, você concorda em',
    loginToAdmin: 'Acesso ao sistema',
    enterUsernameAndPasswordToAccessControlPanelOf: 'Informe email e senha para acessar o sistema',
    havingAnAccount: 'Possui uma conta?',
    ...
    enterYourEmailToSendYouAResetLink: "Informe seu email para receber um link para redefinição da senha",
    pleaseEnterYourPasswordToReset: "Informe sua senha para redefinir",
    saas: "SAAS",
    overallTrafficStatus: "Status geral do tráfego",
    projectManagement: "Gerenciamento de projetos",
    projectTaskManagement: "Gerenciamento de tarefas do projeto",
