...
export default {
    ...
    userRegister: 'Cadastrar Usuário',
    ...
    follow: 'Follow',
    unfollow: 'Unfollow',
    basicValidation: 'Validação Básica',
    ...
    bySigningUpYouAgreeTo: 'Ao se inscrever, você concorda em',
    loginToAdmin: 'Acesso a Área Restrita',
    enterUsernameAndPasswordToAccessControlPanelOf: 'Informe o email e senha para acessar o sistema.',
    ...
    enterYourEmailToSendYouAResetLink: "Informe seu email para receber o link para redefinir sua senha",
    pleaseEnterYourPasswordToReset: "Informe sua nova senha",
    saas: "SAAS",
    ...
    sentEmailSuccessfull: "Email enviado com sucesso",
