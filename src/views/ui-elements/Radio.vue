<template>
	<div>
		...
		<v-container fluid class="grid-list-xl pt-0 mt-n3">
			...
			<v-row>
				<app-card :heading="$t('message.radiosDirectionColumn')" colClasses="col-12 col-md-6">
				...
				>
					<v-row>
						<v-col cols="12" sm="6" md="6" class="col-height-auto">
			...
			<v-row>
				...
				>
					<v-row>
						<v-col cols="12" sm="6" md="4" class="col-height-auto">
							<v-switch 
								label="red"
								v-model="ex11"
								color="red"
