		...
		<v-container fluid class="pt-0 grid-list-xl">
			...
			<v-row>
				<app-card
					...
					:closeable="true"
				>
					<sales class="mb-5" :height="330"></sales>	
			...
			<v-row>
				...
				<app-card
					...
					:fullBlock="true"
				>
					<v-row class="cart-wrap ma-0">
						<v-col hidden-xs-only sm="4">
							<div class="pa-2">
			...
			<v-row>
				...
				<v-col xl="4" md="5" lg="4" sm="12" cols="12">					
					<!-- Weekly Sales -->
					<v-row>
						<app-card
			...
			<v-row>
				...
				<v-col cols="12" sm="6" md="4" lg="4" class="flex">
