         ...
         <div class="user-detail d-custom-flex justify-content-between">
            <div class="media w-80">
               ...
               <div class="media-body">
                  ...
                  <p class="mb-0 fs-14">From <span class="fs-12 grey--text fw-normal">&lt;{{selectedEmail.userEmail}}&gt;</span></p>
                  <p class="mb-0 fs-14">To: <span class="fs-12 grey--text fw-normal">Me</span></p>
               </div>
            </div>
            <span class="align-items-center fs-12 fw-normal d-custom-flex grey--text w-20 justify-end">{{selectedEmail.time}} Hour Ago</span>
         </div>
